...
{
	// Mixin content Type 1066 with alias "page"
	/// <summary>Page</summary>
	public partial interface IPage : IPublishedContent
	{
		/// <summary>Page Main Text</summary>
		IHtmlString PageMainText { get; }
...
#pragma warning restore 0109
		...
		{
			get { return GetPageMainText(this); }
		}

		/// <summary>Static getter for Page Main Text</summary>
		public static IHtmlString GetPageMainText(IPage that) { return that.GetPropertyValue<IHtmlString>("pageMainText"); }
